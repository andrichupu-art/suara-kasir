          ...
          <div className="px-5 py-6 lg:px-10">
            {activeTab === "kasir" && <>
              ...
              <section className="mt-6 grid gap-5 xl:grid-cols-[1.1fr_0.9fr]">
                ...
                {cart.length > 0 && <div className="fixed bottom-[222px] left-5 right-5 z-10 max-h-[276px] overflow-y-auto rounded-[2rem] bg-transparent p-0 shadow-none lg:static lg:max-h-none lg:overflow-visible lg:rounded-[2rem] lg:bg-white lg:p-5 lg:shadow-sm">
